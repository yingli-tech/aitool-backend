  ...
  try:
    ...
    for ranked in ranked_results:
      ...
      merged.append({
        ...
        "matched_use_case_primary_tag_count": ranked.get("matched_use_case_primary_tag_count", 0),
        "matched_use_case_secondary_tag_count": ranked.get("matched_use_case_secondary_tag_count", 0),
        "matched_function_primary_tag_count": ranked.get("matched_function_primary_tag_count", 0),
        "matched_function_secondary_tag_count": ranked.get("matched_function_secondary_tag_count", 0),
        "matched_nice_to_have_primary_tag_count": ranked.get("matched_nice_to_have_primary_tag_count", 0),
        "matched_nice_to_have_secondary_tag_count": ranked.get("matched_nice_to_have_secondary_tag_count", 0),
